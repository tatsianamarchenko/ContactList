...
class FavoriteViewController: UIViewController {
	...
	override func viewWillAppear(_ animated: Bool) {
		...
		for index in 0..<ContactStorageManager.contactsSourceArray.contacts.count
		where ContactStorageManager.contactsSourceArray.contacts[index].isFavorite {
			arrayOfFavorite.append(ContactStorageManager.contactsSourceArray.contacts[index])
		}
